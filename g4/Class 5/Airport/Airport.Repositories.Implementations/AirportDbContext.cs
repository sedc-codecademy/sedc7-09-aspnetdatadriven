    ...
    public class AirportDbContext : DbContext
    {
        ...
        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        {
            var connectionString = 
                @"Data Source=(localdb)\MSSQLLocalDB;Application Name=Airport;Initial Catalog=AirportDb;Integrated Security=True;";
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            modelBuilder.Entity<BusinessObject>(businessObject =>
            {
                ...
                businessObject.HasMany(bo => bo.ResponsibleEmployees)
                                .WithOne(boe => boe.BusinessObject)
                                .HasForeignKey(boe => boe.BusinessObjectId);
            ...
            {
                employee.HasMany(e => e.ResponsibleFor)
                        .WithOne(boe => boe.ResponsibleEmployee)
                        .HasForeignKey(boe => boe.ResponsibleEmployeeId);
            ...
            modelBuilder.Entity<BusinessObjectEmployee>(businessObjectEmployee =>
            {
                businessObjectEmployee.HasKey(boe => 
                                                new { boe.BusinessObjectId, boe.ResponsibleEmployeeId });
            }
            );
        }
    }
